...
definition(
    name: "Scheduled Mode Change with Time and Presence",
...
preferences {
    ...
    section("Select Presence Sensors") {
        input "presence", "capability.presenceSensor", title: "Select Presence Devices", multiple: true
    }
	section("Change to this mode when empty") {
		input "emptyMode", "mode", title: "Mode?"
	}
    section("Change to this mode when not empty") {
        input "notEmptyMode", "mode", title: "Mode?"
    }
